from agents.MCTS.Search_Node import Search_Node


class MCTS_Search_Node(Search_Node):
    ...
    def find_successor_after_action(self,action):
        ...
        return MCTS_Search_Node(self.environment,new_observation, parent_node=self,parent_action=action,parent_reward=reward,terminal=done,legal_actions=legal_actions)
