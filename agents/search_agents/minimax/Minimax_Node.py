...
class Minimax_Node(Search_Node):
    ...
    def find_successor_after_action(self,action):
        ...
        return Minimax_Node(self.environment,new_observation, parent_node=self,parent_action=action,parent_reward=reward,terminal=done,legal_actions=legal_actions)
