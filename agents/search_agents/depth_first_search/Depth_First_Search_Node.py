...
class Depth_First_Search_Node(Search_Node):
    ...
    def find_successor_after_action(self,action):
        ...
        return Depth_First_Search_Node(self.environment,new_observation, parent_node=self,parent_action=action,parent_reward=reward,terminal=done,legal_actions=legal_actions)
